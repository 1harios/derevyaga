 ...
 *
 * Источник — прайс компании (расчёт комплектации, скриншоты от 02.09.2026): цены домов
 * со сборкой по всем пяти размерам, число и цена свай (винтовые 4 500 ₽, железобетонные
 * 6 500 ₽ за сваю с монтажом), точка доставки — посёлок Янино, доставка при 0 км не
 * считается. Надбавки за утепление, кровлю, фасад и скидка за отказ от террасы в прайсе
 * не показаны — помечены ЗАМЕНИТЬ и ждут цифр.
 *
...
export const constructorConfig = {
  ...
  sizes: [
    ...
    { id: '6x8', label: '6×8', area: 48, basePrice: 828_000, piles: 20, note: 'две комнаты' },
    { id: '6x10', label: '6×10', area: 60, basePrice: 1_056_000, piles: 24, note: 'три комнаты' },
    { id: '8x8', label: '8×8', area: 64, basePrice: 1_104_000, piles: 24, note: 'квадратный план' },
    { id: '8x10', label: '8×10', area: 80, basePrice: 1_408_000, piles: 26, note: 'для семьи' },
   ...
   * Из прайса: винтовые 108 мм — 4 500 ₽ (72 000 / 16), железобетонные — 6 500 ₽ (104 000 / 16).
   */
  foundations: [
    {
      id: 'screw',
  ...
  /** Доставка от Янино считается по километрам; при 0 км итог показывается «без доставки» */
  delivery: { base: 0, perKm: 100, maxKm: 400 }, // perKm — ЗАМЕНИТЬ: в прайсе тариф не показан
